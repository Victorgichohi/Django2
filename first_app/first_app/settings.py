...
SECRET_KEY = '2nn+q7s@cwg5vzi3#31b!h#_vjqh=95^&a%pz)zkqv6!33hait'
...
EMAIL_HOST_PASSWORD='tK1YZfYMFKQKqVW4sW2Abg'
...
STATIC_ROOT= os.path.join(os.path.dirname(BASE_DIR), "assets", "static_prod")
